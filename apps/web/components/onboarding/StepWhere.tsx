  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <input
        ...
        className="w-full bg-white border border-[rgba(37,99,235,0.08)] rounded-[10px] px-5 py-4 text-lg text-gray-dark placeholder-on-light-tertiary focus:outline-none focus:ring-2 focus:ring-accent transition mb-6"
        autoFocus
      />
          ...
          <button
            ...
            className={`px-4 py-2 rounded-pill border text-sm font-medium transition-colors ${
              prefs.destination === place
                ...
                : "border-[rgba(37,99,235,0.08)] text-on-light-secondary hover:border-accent/30"
            }`}
          >
            {place}
          </button>
