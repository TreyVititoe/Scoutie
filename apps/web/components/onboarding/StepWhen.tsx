  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <div className="space-y-4 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-[rgba(37,99,235,0.08)] rounded-[10px] px-5 py-4 text-lg text-gray-dark focus:outline-none focus:ring-2 focus:ring-accent transition"
          />
        </div>
        <div>
      ...
      <div className="mt-auto flex gap-3">
        <button
          onClick={onBack}
          className="flex-1 border border-[rgba(37,99,235,0.08)] text-on-light-secondary font-semibold py-4 rounded-[10px] text-lg hover:bg-page-bg transition-colors"
        >
          Back
        </button>
        <button
