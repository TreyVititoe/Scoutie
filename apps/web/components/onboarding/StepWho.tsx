      ...
      <div className="bg-page-bg rounded-[14px] px-5 py-4 flex items-center justify-between mb-10">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="w-9 h-9 rounded-full border border-[rgba(0,101,113,0.08)] bg-white text-gray-dark font-semibold text-lg flex items-center justify-center hover:border-accent/30 transition"
          >
            −
          </button>
