              ...
              <div className="px-4 pb-2 flex flex-wrap gap-1.5 flex-shrink-0">
                {QUICK_SUGGESTIONS.map((suggestion) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-3 py-1.5 text-xs font-sans font-medium rounded-pill border border-[rgba(37,99,235,0.08)] text-on-light-secondary hover:border-accent/30 hover:bg-accent/5 transition-colors"
                  >
                    {suggestion}
                  </motion.button>
                ))}
            ...
            <div className="border-t border-black/10 px-4 py-3 flex-shrink-0">
              <div className="flex gap-2">
                <input
                  ...
                  disabled={loading}
                  className="flex-1 px-3.5 py-2.5 rounded-[10px] border border-[rgba(37,99,235,0.08)] bg-white text-sm font-sans text-gray-dark placeholder:text-on-light-tertiary focus:outline-none focus:ring-accent/20 focus:ring-accent focus:ring-1 disabled:opacity-50 transition-colors"
                />
                <motion.button
