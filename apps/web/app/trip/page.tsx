    ...
    >
      <div className="flex items-start gap-4">
        ...
        {item.image ? (
          ...
          <div className="w-20 h-20 rounded-[8px] flex-shrink-0 bg-[#DBEAFE] flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span
              className="bg-[#DBEAFE] text-accent rounded-pill px-2.5 py-0.5 text-[11px] font-semibold uppercase"
            >
              {item.type}
            </span>
            {isAi ? (
