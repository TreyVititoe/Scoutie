    ...
    <div className="min-h-screen bg-page-bg">
      ...
      <header className="sticky top-0 z-20 nav-glass">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <span className="w-7 h-7 rounded-[8px] bg-gradient-to-br from-cyan to-accent-light flex items-center justify-center shadow-[0_2px_10px_rgba(121,231,248,0.3)]">
      ...
      <section className="bg-hero-gradient relative overflow-hidden pt-16 sm:pt-20 pb-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span aria-hidden="true" className="w-px bg-[rgba(0,101,113,0.1)] my-2.5" />
            <label className="flex-1 px-5 py-2.5 text-left rounded-full hover:bg-page-bg/60 transition-colors cursor-text min-w-0">
      ...
      <section className="bg-page-bg -mt-20 pb-20 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-white rounded-[28px] p-6 sm:p-10 shadow-[0_8px_40px_rgba(0,101,113,0.1)] border border-[rgba(0,101,113,0.04)]">
                  ...
                  .map((trip) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between pt-2.5 mt-2.5 border-t border-[rgba(0,101,113,0.05)]">
