  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl text-text mb-4">
          Privacy Policy
        </h1>
        ...
        <div className="space-y-10 text-text-secondary leading-relaxed">
          <section>
            <h2 className="font-display font-bold text-xl text-text mb-3">
              1. Introduction
            </h2>
            <p>
              Walter (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong className="text-text">Affiliate click data</strong> --
                When you click through to booking partners, we record the click
                for commission tracking purposes.
              </li>
              <li>
                <strong className="text-text">Usage data</strong> -- Browser
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong className="text-text">Portability</strong> -- Request
                your data in a portable, machine-readable format.
              </li>
              <li>
                <strong className="text-text">Opt-out</strong> -- Opt out of
