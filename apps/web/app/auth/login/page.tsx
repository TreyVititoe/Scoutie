    ...
    return (
      <div className="min-h-screen bg-page-bg flex items-center justify-center px-4">
        <div className="card-base p-8 max-w-md w-full text-center">
          <div className="w-14 h-14 rounded-full bg-[#e6f7f9] flex items-center justify-center mx-auto mb-4">
    ...
    <div className="min-h-screen bg-page-bg flex items-center justify-center px-4">
      <div className="card-base p-8 max-w-md w-full">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-[10px] border border-[rgba(0,101,113,0.08)] bg-white font-semibold text-gray-dark hover:bg-page-bg transition-colors mb-4"
        >
        ...
        <div className="flex items-center gap-4 my-6">
          <div className="flex-1 h-px bg-[rgba(0,101,113,0.06)]" />
