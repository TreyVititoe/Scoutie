    ...
    return (
      <div className="min-h-screen bg-page-bg flex items-center justify-center px-4">
        <div className="card-base p-8 max-w-md w-full text-center">
          ...
          <h2 className="font-semibold text-[21px] text-ink mb-2">Check your email</h2>
  ...
  return (
    <div className="min-h-screen bg-page-bg flex items-center justify-center px-4">
      <div className="card-base p-8 max-w-md w-full">
        <Link href="/" className="font-semibold text-[21px] text-ink block text-center mb-2">
          Walter
        </Link>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-[10px] border border-[rgba(91,141,239,0.08)] bg-white font-semibold text-ink hover:bg-page-bg transition-colors mb-4"
        >
        ...
        <form onSubmit={handleMagicLink}>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 rounded-[10px] border border-[rgba(91,141,239,0.08)] text-ink placeholder:text-ink-faint focus:outline-none focus:ring-2 focus:ring-accent/20 mb-4"
          />
          {error && <p className="text-sm text-red-500 mb-3">{error}</p>}
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-[10px] bg-accent text-white font-semibold disabled:opacity-50 hover:bg-accent-light transition-colors"
          >
